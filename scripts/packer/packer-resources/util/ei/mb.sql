...
DROP DATABASE IF EXISTS WSO2_CONFIG_GOV_DB;
DROP DATABASE IF EXISTS WSO2_MB_DB;

CREATE DATABASE WSO2_USER_DB;
CREATE DATABASE WSO2_CONFIG_GOV_DB;
CREATE DATABASE WSO2_MB_DB;
